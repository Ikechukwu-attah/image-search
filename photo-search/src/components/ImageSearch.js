    ...
    return (
        <div className='max-w-sm rounded overflow-hidden my-10 mx-auto'>
          <form onSubmit={onSubmit} className='w-full max-w-sm'>
            <div className = 'flex items-center border-b boarder-b-2 border-teal-500 py-2'>
              <input className='apperance-none bg-transparent border-none w-full text-gray-700 mr-3 py-1 px-2
